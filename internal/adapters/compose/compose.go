// Package compose implements the Docker Compose adapter for the Agentz toolchain.
package compose
...
func (a *Adapter) Export(_ context.Context, resources []ir.Resource, outDir string) error {
	...
	sb.WriteString("# Generated by agentz - do not edit\n")
	...
	if len(envVars) > 0 {
		...
		envSB.WriteString("# Generated by agentz - do not edit\n")
